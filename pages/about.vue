            ...
            <div class="max-w-lg mx-auto mb-16 lg:mb-0 lg:mx-0">
                ...
                <main>
                    <div class="mb-12">
                        ...
                        <p>
                            I’m Cody. I'm currently enjoying life with my wife
                            in our vintage 1977 Toyota RV. We are actively
                            chasing sunshine and warmth while finding the
                            occasional surf and/or hot spring.
                        </p>

                        <AboutSection
                            v-for="linkObj in allLinks"
                            :links="linkObj.links"
                            :header="linkObj.header"
                            :separate="true"
                        />
                    </div>

                    <h2 class="text-lg font-normal">Elsewhere</h2>
                    <p class="my-4">
                        You can
                        <NuxtLink class="underline" to="subscribe">
                    ...
                    <p class="my-4">
                        ...
                        <a class="underline" href="https://obsidian.md">
                            Obsidian
                        </a>
                    ...
                    <p class="my-4">
                        ...
                        <a class="underline" href="https://nuxt.studio"
                            >Nuxt Studio</a
                        >.
                    </p>
                    <p class="my-4">
                        The site is styled using
                        <a class="underline" href="https://tailwindcss.com"
                            >tailwindcss</a
                        >.
                    </p>
