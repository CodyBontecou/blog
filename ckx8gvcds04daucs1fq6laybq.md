...
![Using Vue Devtools to debug Electron application running VueJS on the frontend.](https://codybontecou.com/images/electron-app-with-vue-devtools-meta.png)
...
You should be all set up now. If you need additional help, check out their [documentation](https://devtools.vuejs.org/) or their GitHub repo [documentation](https://github.com/vuejs/devtools/tree/legacy/packages/shell-electron#vue-remote-devtools).
