...
const issueTitle = `[Feedback] The homepage is missing a search functionality. It would ...`
const issueBody = `## Feedback

The homepage is missing a search functionality. It would be great to add a search bar in the header to help users find blog posts quickly.

**Page URL**: https://codybontecou.com
**User Email**: test@example.com

---
*Submitted via [Pullreque.st](https://pullreque.st)*`
const issueUrl = 'https://github.com/CodyBontecou/blog/issues/81'
