...
const issueTitle = `[Feedback] The blog posts need better formatting. Add code syntax hi...`
const issueBody = `## Feedback

The blog posts need better formatting. Add code syntax highlighting for code blocks and improve the typography for better readability.

**Page URL**: https://codybontecou.com/blog
**User Email**: formatting@example.com

---
*Submitted via [Pullreque.st](https://pullreque.st)*`
const issueUrl = 'https://github.com/CodyBontecou/blog/issues/84'
