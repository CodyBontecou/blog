...
function newLesson() {
  router.go(`/admin/lessons?courseId=${props.courseId}&lessonId=new`)
}

function editLesson(lessonId: string) {
  router.go(`/admin/lessons?courseId=${props.courseId}&lessonId=${lessonId}`)
}
...
.lesson-card:hover {
  border-color: #1a1a1a;
  box-shadow: 0 4px 12px rgba(193, 99, 79, 0.08);
