        ...
        <div class="max-w-lg mx-auto mb-16 lg:mb-0 lg:mx-0 lg:pr-4">
          <div class="">
            ...
            <div class="mb-8 w-full">
              <ToggleSwitch v-model="isAboutView" @update:modelValue="handleViewToggle" />
            </div>
              ...
              <section class="w-full">
                ...
                <div class="prose prose-gray max-w-none">
                  <p class="text-gray-700 leading-relaxed mb-4">
                    I'm a software engineer with a passion for building meaningful products and sharing knowledge through writing.
                  </p>
                  
                  <p class="text-gray-700 leading-relaxed mb-4">
                    My interests span across TypeScript, Vue.js, accessibility, AI, and the evolving landscape of web development. 
                    I enjoy exploring new technologies and documenting my learnings along the way.
                  </p>
                  
                  <p class="text-gray-700 leading-relaxed mb-6">
                    When I'm not coding, you'll find me experimenting with new tools, contributing to open source, 
                    or writing about the intersection of technology and human experience.
                  </p>
                  
                  <div class="space-y-3">
                    <h3 class="text-gray-900 font-medium">Connect</h3>
                    <div class="flex flex-col space-y-2">
                      <a href="https://github.com/codybontecou" class="text-blue-600 hover:underline flex items-center gap-2">
                        <span>GitHub</span>
                      ...
                      <a href="https://twitter.com/codybontecou" class="text-blue-600 hover:underline flex items-center gap-2">
                        <span>Twitter</span>
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
